...
ניהול מלאי בגדי ילדים, ארגזי אחסון, מעבר עונות, וסטיילינג חכם בסיוע AI.
...
| מלאי | `/inventory` | כרטיסיות ניתנות לסינון + הוספת בגדים חדשים |
| ארגזים | `/boxes` | גלריה מורחבת + הדפסת מניפסט לכל ארגז |
...
לחץ "צור דוח" בדף הבית לקבלת סיכום בעברית על אילו ארגזים להוציא לקראת העונה הקרובה.
